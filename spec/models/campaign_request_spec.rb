...
# Unit tests for VippsRecurring::CampaignRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VippsRecurring::CampaignRequest do
  let(:instance) { VippsRecurring::CampaignRequest.new }

  describe 'test an instance of CampaignRequest' do
    it 'should create an instance of CampaignRequest' do
      expect(instance).to be_instance_of(VippsRecurring::CampaignRequest)
    end
  end
