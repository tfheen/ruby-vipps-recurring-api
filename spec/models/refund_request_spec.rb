...
# Unit tests for VippsRecurring::RefundRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VippsRecurring::RefundRequest do
  let(:instance) { VippsRecurring::RefundRequest.new }

  describe 'test an instance of RefundRequest' do
    it 'should create an instance of RefundRequest' do
      expect(instance).to be_instance_of(VippsRecurring::RefundRequest)
    end
  end
