...
# Unit tests for VippsRecurring::Agreement
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VippsRecurring::Agreement do
  let(:instance) { VippsRecurring::Agreement.new }

  describe 'test an instance of Agreement' do
    it 'should create an instance of Agreement' do
      expect(instance).to be_instance_of(VippsRecurring::Agreement)
    end
  end
  ...
  describe 'test attribute "userinfo_url"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
