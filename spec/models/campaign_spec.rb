...
# Unit tests for VippsRecurring::Campaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VippsRecurring::Campaign do
  let(:instance) { VippsRecurring::Campaign.new }

  describe 'test an instance of Campaign' do
    it 'should create an instance of Campaign' do
      expect(instance).to be_instance_of(VippsRecurring::Campaign)
    end
  end
