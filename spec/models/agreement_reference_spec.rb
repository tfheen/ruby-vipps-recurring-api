...
# Unit tests for VippsRecurring::AgreementReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VippsRecurring::AgreementReference do
  let(:instance) { VippsRecurring::AgreementReference.new }

  describe 'test an instance of AgreementReference' do
    it 'should create an instance of AgreementReference' do
      expect(instance).to be_instance_of(VippsRecurring::AgreementReference)
    end
  end
  describe 'test attribute "agreement_resource"' do
    it 'should work' do
  ...
  describe 'test attribute "vipps_confirmation_url"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
