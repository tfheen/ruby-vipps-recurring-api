...
# Unit tests for VippsRecurring::AgreementStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VippsRecurring::AgreementStatus do
  let(:instance) { VippsRecurring::AgreementStatus.new }

  describe 'test an instance of AgreementStatus' do
    it 'should create an instance of AgreementStatus' do
      expect(instance).to be_instance_of(VippsRecurring::AgreementStatus)
    end
  end
end
