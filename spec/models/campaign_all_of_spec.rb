...
# Unit tests for VippsRecurring::CampaignAllOf
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VippsRecurring::CampaignAllOf do
  let(:instance) { VippsRecurring::CampaignAllOf.new }

  describe 'test an instance of CampaignAllOf' do
    it 'should create an instance of CampaignAllOf' do
      expect(instance).to be_instance_of(VippsRecurring::CampaignAllOf)
    end
  end
