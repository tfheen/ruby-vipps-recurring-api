...
# Unit tests for VippsRecurring::ChargeReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VippsRecurring::ChargeReference do
  let(:instance) { VippsRecurring::ChargeReference.new }

  describe 'test an instance of ChargeReference' do
    it 'should create an instance of ChargeReference' do
      expect(instance).to be_instance_of(VippsRecurring::ChargeReference)
    end
  end
