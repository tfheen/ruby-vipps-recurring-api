...
# Unit tests for VippsRecurring::ChargeStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VippsRecurring::ChargeStatus do
  let(:instance) { VippsRecurring::ChargeStatus.new }

  describe 'test an instance of ChargeStatus' do
    it 'should create an instance of ChargeStatus' do
      expect(instance).to be_instance_of(VippsRecurring::ChargeStatus)
    end
  end
end
