...
# Unit tests for VippsRecurring::Charge
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VippsRecurring::Charge do
  let(:instance) { VippsRecurring::Charge.new }

  describe 'test an instance of Charge' do
    it 'should create an instance of Charge' do
      expect(instance).to be_instance_of(VippsRecurring::Charge)
    end
  end
