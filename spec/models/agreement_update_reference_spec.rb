...
# Unit tests for VippsRecurring::AgreementUpdateReference
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VippsRecurring::AgreementUpdateReference do
  let(:instance) { VippsRecurring::AgreementUpdateReference.new }

  describe 'test an instance of AgreementUpdateReference' do
    it 'should create an instance of AgreementUpdateReference' do
      expect(instance).to be_instance_of(VippsRecurring::AgreementUpdateReference)
    end
  end
