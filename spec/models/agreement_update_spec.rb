...
# Unit tests for VippsRecurring::AgreementUpdate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VippsRecurring::AgreementUpdate do
  let(:instance) { VippsRecurring::AgreementUpdate.new }

  describe 'test an instance of AgreementUpdate' do
    it 'should create an instance of AgreementUpdate' do
      expect(instance).to be_instance_of(VippsRecurring::AgreementUpdate)
    end
  end
