...
# Unit tests for VippsRecurring::AccessTokenResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VippsRecurring::AccessTokenResponse do
  let(:instance) { VippsRecurring::AccessTokenResponse.new }

  describe 'test an instance of AccessTokenResponse' do
    it 'should create an instance of AccessTokenResponse' do
      expect(instance).to be_instance_of(VippsRecurring::AccessTokenResponse)
    end
  end
  ...
  describe 'test attribute "ext_expires_in"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
