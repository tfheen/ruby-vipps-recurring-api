...
# Unit tests for VippsRecurring::Interval
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VippsRecurring::Interval do
  let(:instance) { VippsRecurring::Interval.new }

  describe 'test an instance of Interval' do
    it 'should create an instance of Interval' do
      expect(instance).to be_instance_of(VippsRecurring::Interval)
    end
  end
end
