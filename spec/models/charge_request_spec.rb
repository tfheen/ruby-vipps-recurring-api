...
# Unit tests for VippsRecurring::ChargeRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VippsRecurring::ChargeRequest do
  let(:instance) { VippsRecurring::ChargeRequest.new }

  describe 'test an instance of ChargeRequest' do
    it 'should create an instance of ChargeRequest' do
      expect(instance).to be_instance_of(VippsRecurring::ChargeRequest)
    end
  end
