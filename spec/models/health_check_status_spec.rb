...
# Unit tests for VippsRecurring::HealthCheckStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VippsRecurring::HealthCheckStatus do
  let(:instance) { VippsRecurring::HealthCheckStatus.new }

  describe 'test an instance of HealthCheckStatus' do
    it 'should create an instance of HealthCheckStatus' do
      expect(instance).to be_instance_of(VippsRecurring::HealthCheckStatus)
    end
  end
  ...
  describe 'test attribute "cosmos_db"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "payment_db"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
