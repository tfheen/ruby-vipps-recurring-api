...
# Unit tests for VippsRecurring::Currency
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe VippsRecurring::Currency do
  let(:instance) { VippsRecurring::Currency.new }

  describe 'test an instance of Currency' do
    it 'should create an instance of Currency' do
      expect(instance).to be_instance_of(VippsRecurring::Currency)
    end
  end
end
