  ...
  class AccessTokenResponse
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VippsRecurring::AccessTokenResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VippsRecurring::AccessTokenResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ext_expires_in')
        self.ext_expires_in = attributes[:'ext_expires_in']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ext_expires_in == o.ext_expires_in &&
    ...
    def hash
      [token_type, expires_in, ext_expires_in, expires_on, not_before, resource, access_token].hash
    end
