...
module VippsRecurring
  class ChargeStatus
    ...
    def build_from_hash(value)
      constantValues = ChargeStatus.constants.select { |c| ChargeStatus::const_get(c) == value }
      raise "Invalid ENUM value #{value} for class #ChargeStatus" if constantValues.empty?
      value
    end
  end
end
