...
module VippsRecurring
  class HealthCheckStatus
    ...
    attr_accessor :cosmos_db

    attr_accessor :payment_db
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VippsRecurring::HealthCheckStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VippsRecurring::HealthCheckStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cosmos_db')
        self.cosmos_db = attributes[:'cosmos_db']
      end

      if attributes.key?(:'payment_db')
        self.payment_db = attributes[:'payment_db']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @cosmos_db.nil?
        invalid_properties.push('invalid value for "cosmos_db", cosmos_db cannot be nil.')
      end

      if @payment_db.nil?
        invalid_properties.push('invalid value for "payment_db", payment_db cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @cosmos_db.nil?
      return false if @payment_db.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cosmos_db == o.cosmos_db &&
          payment_db == o.payment_db
    end
    ...
    def hash
      [application, cosmos_db, payment_db].hash
    end
